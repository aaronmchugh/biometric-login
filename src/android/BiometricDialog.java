public class BiometricDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    public BiometricDialog(@NonNull Context context, int theme) {
        super(context, theme);
    }

    protected BiometricDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
